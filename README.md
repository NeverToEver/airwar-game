...
> ⚠️ **【开发状态】** ⚠️
> 
> **当前难度系统正处于设计阶段（v2.0 设计文档已完成）。**
> 
> 以下表格中的数值为**当前实现版本**，仅作为参考基准。新的非线性难度系统将基于 **Boss 击杀数量** 实现指数级难度增长，并区分简单/普通/困难三种模式。
> 
> 📄 详细设计文档：`docs/nonlinear_difficulty_system_design.md`
