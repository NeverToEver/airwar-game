...
class Boss(Entity):
    ...
    _warning_surface: Optional[pygame.Surface] = None
    _escape_surface: Optional[pygame.Surface] = None
    ...
    @classmethod
    def _get_warning_surface(cls) -> pygame.Surface:
        if cls._warning_surface is None:
            cls._warning_surface = pygame.font.Font(None, 36).render("! WARNING !", True, (255, 50, 50))
        return cls._warning_surface

    @classmethod
    def _get_escape_surface(cls) -> pygame.Surface:
        if cls._escape_surface is None:
            cls._escape_surface = pygame.font.Font(None, 28).render("ESCAPING...", True, (255, 200, 50))
        return cls._escape_surface
    ...
    def render(self, surface: pygame.Surface) -> None:
        ...
        if self.entering:
            ...
            warning_surf = self._get_warning_surface()
        ...
        if self._show_escape_warning and not self.entering:
            ...
            warning_surf = self._get_escape_surface()
            warning_surf.set_alpha(int(255 * pulse))
            warning_rect = warning_surf.get_rect(center=(surface.get_width() // 2, warning_y))
            surface.blit(warning_surf, warning_rect)
