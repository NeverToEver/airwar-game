...
The entity coordinates motion and rendering. All visual logic lives in
...
class MotherShip:
    ...
    - :meth:`update_animation` (primarily used by :meth:`render`)
    ...
    def __init__(self, screen_width: int, screen_height: int):
        ...
        # Renderer reads live state through the owning entity.
