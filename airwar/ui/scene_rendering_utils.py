...
def draw_centered_option_box(
    ...
    box_width: int,
    box_height: int,
    selected_bg_color: Sequence[int],
    selected_border_color: Sequence[int],
    unselected_bg_color: Sequence[int],
    unselected_border_color: Sequence[int],
    selected_glow_color: Sequence[int],
    selected_text_color: Sequence[int],
    unselected_text_color: Sequence[int],
    glow_layers: int = 3,
