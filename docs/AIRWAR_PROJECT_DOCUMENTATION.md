...
└── archives/                         # 历史文档归档
    ├── README.md                      # 归档说明
    ├── CHANGELOG_v3.2.md            # v3.2变更日志
    ├── EMERGENCY_CODE_AUDIT_REPORT.md # 紧急代码审核报告
    ├── EXECUTIVE_SUMMARY.md         # 审核执行摘要
    ├── FEASIBILITY_VERIFICATION.md  # 修复方案可行性验证
    ├── FIXES_IMPLEMENTED.md         # 修复完成报告
    ├── RECOVERY_PLAN.md             # 分阶段恢复计划
    ├── TECHNICAL_DOCUMENTATION_REVIEW_AND_WORK_PLAN.md # 技术文档审查
    └── phase2-code-review-2026-04-20.md # Phase 2代码审查
```
...
| 文档 | 说明 |
|------|------|
| `AIRWAR_PROJECT_DOCUMENTATION.md` | 本文档 - 核心项目文档 |
| `CHANGELOG.md` | 项目变更日志 |
| `archives/README.md` | 历史文档归档索引 |
...
| 3.1 | 2025-01-XX | 添加Buff系统重构详解 |
| 3.2 | 2026-04-20 | Phase 2&3优化、测试增强 |
| 3.3 | 2026-04-21 | 死亡动画、K键放弃、代码审查修复 |
...
*本文档为AIRWAR项目核心文档，整合了项目概述、架构设计、问题追踪、修复流程、技术设计、Buff系统重构等内容。完整变更历史请参见 CHANGELOG.md。历史文档请参见 archives/ 目录。*
